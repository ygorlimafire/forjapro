...
-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('INDICACAO', 'SITE', 'INSTAGRAM', 'GOOGLE', 'FEIRA', 'LIGACAO', 'EMAIL', 'OUTRO');

-- CreateEnum
CREATE TYPE "LeadStatus" AS ENUM ('NOVO', 'CONTATO', 'QUALIFICADO', 'CONVERTIDO', 'DESCARTADO');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('LIGACAO', 'EMAIL', 'REUNIAO', 'VISITA', 'WHATSAPP', 'TAREFA', 'NOTA');
...
CREATE TABLE "CompanySettings" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'FORJA PRO',
    "cnpj" TEXT,
    "street" TEXT,
    "number" TEXT,
    "complement" TEXT,
...
-- AddForeignKey
ALTER TABLE "OpportunityStageHistory" ADD CONSTRAINT "OpportunityStageHistory_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
